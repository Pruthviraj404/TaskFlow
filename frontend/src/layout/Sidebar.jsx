...
export default function Sidebar({ tasks, stats, activeScreen, setActiveScreen, filter, setFilter, user, onLogout }) {
  ...
  return (
    <aside className="w-64 bg-[#121212] text-white flex flex-col shrink-0 border-r border-white/5">
      <div className="p-6">
        {/* Logo Area - Returns to Dashboard */}
        <div 
        ...
        >
          ...
          <h1 className="text-xl font-black text-white tracking-tight">TaskFlow</h1>
        </div>
        
        {/* Main Menu Section */}
        <div className="mb-8">
          <p className="text-[10px] font-bold text-gray-600 mb-4 px-3 uppercase tracking-[0.2em]">Main Menu</p>
        ...
        <div>
          <p className="text-[10px] font-bold text-gray-600 mb-4 px-3 uppercase tracking-[0.2em]">Quick Filters</p>
          <nav className="space-y-1.5">
            <SidebarItem 
              icon={Briefcase} 
              label="Work" 
      ...
      {/* User Footer - Profile & Settings Toggle */}
      <div className="mt-auto p-4 bg-white/5 border-t border-white/5 space-y-3">
        ...
        >
          <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center font-bold text-sm shadow-lg shadow-blue-500/20 text-white">
          ...
          <div className="text-left overflow-hidden flex-1">
            ...
            <p className="text-[10px] text-gray-500 truncate">{user?.email || 'Sign in to sync'}</p>
          </div>
          <Settings 
            size={16} 
